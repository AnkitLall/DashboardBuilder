...
import { worldData } from '../../Config/WorldData';
import { worldLand } from '../../Config/WorldLand';
...
const cities = [
    ...
    { name: "New York",       country:'USA',coordinates: [-74.0059,40.7128],  population: 20630000 },
...
export default function GeoMap() {
    ...
    let [geographies, setGeographies] = useState(feature(worldLand, worldLand.objects.land).features)
    ...
    return(
        <svg width={800} height={450} viewBox={'0 0 800 450'}>
            ...
            </g>
            {
                ...
                <g className={'labels'}>
                    <text
                        x={ projection(selectedCity.coordinates)[0]+15 }
                        y={ projection(selectedCity.coordinates)[1] }
                        fontSize={7}
                        fill={"#E91E63"}
                        dy={'1.5em'}
                    >
                    ...
                    <PersonFill 
                        size={10}
                        x={ projection(selectedCity.coordinates)[0]+15 }
                        y={ projection(selectedCity.coordinates)[1]-9 }
                    />
                    <text
                        x={ projection(selectedCity.coordinates)[0]+30 }
                        y={ projection(selectedCity.coordinates)[1] }                        
                        fontSize={10}
                        fill={"#E91E63"}
                    >
